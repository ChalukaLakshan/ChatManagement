namespace ChatManagement.Endpoints
{
    public static class AgentEndPoints
    {
        ...
        {
            app.MapPost("/api/agents", async (Service.IBusinessServiceProvider businessServiceProvider, Service.Dto.CreateAgentDto request) =>
            {
            ...
            app.MapPost("/api/agents/authenticate", async (Service.IBusinessServiceProvider businessServiceProvider, Service.Dto.LoginDto request) =>
            {
